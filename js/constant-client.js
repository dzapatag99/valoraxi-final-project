                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-transparent position-relative w-100" id="navbar">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <li class="nav-item me-2">
                                    <a class="btn btn-light" href="sign-in-clie.html">${client.username} <button type="button" class="btn btn-danger bi bi-box-arrow-left" onClick="logOut()"><i class="fas fa-sign-out-alt"></i></button></a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-warning" href="sign-in-tax.html">Accede como taxista</a>
                                </li>
                                </ul>
                            </div>
                            </div>
